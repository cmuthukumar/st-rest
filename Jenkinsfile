...
retry(1)
    ...
    def runTests(param)
    {
    	...
    	runPlaybook("run_tests.yml","-i inventories/${CloudProviders}/${params[0]}/ -i inventories/${CloudProviders}/${params[1]}","-e as2_totalcreatehosts=600 -e as2_filespermin=190 -e as2_totalmins=120 -e as2_totalhosts=600 -e ftp_totalcreatehosts=300 -e ftp_filespermin=190 -e ftp_totalmins=120 -e ftp_totalhosts=300 -e sshftp_totalcreatehosts=300 -e sshftp_filespermin=190 -e sshftp_totalmins=120 -e sshftp_totalhosts=300","all")
    ...
    def monitorTests(param)
    {
    	...
    	runPlaybook("monitor_tests.yml","-i inventories/${CloudProviders}/${params[0]}/ -i inventories/${CloudProviders}/${params[1]}","-e as2_filespermin=190 -e as2_totalmins=120 -e ftp_filespermin=190 -e ftp_totalmins=120  -e sshftp_filespermin=190 -e sshftp_totalmins=120","all")
